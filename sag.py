...
tmax = 200 #numero maximo de iterações
rest = 10 #restart
...
nd = 5 #dimensão do vetor solução
...
IcumPops = [] #Lista com os valores de infectados para cada população
...
for t in range(tmax):
    ...
    IcumPops += [func(x_old)[1]] #TODO: certificar-se que essa etapa não atrasa significamente o código
...
df2 = pd.DataFrame(IcumPops, columns = ['Icum1', 'Icum2', 'Icum3', 'Icum4', 'Icum5'])
df2.to_csv("./valores_Infectados.csv", sep=',')
